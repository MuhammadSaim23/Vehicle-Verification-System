...
<body>
    ...
    echo "<tr>";
        ...
        echo "<td><a href='delete_1.php?id=" . $result["ID"]. "'><button type='button' style=' background-color: gray; border-radius: 15px; width: 80px; height: 30px;'>Remove</button></a></td>";
    echo "</tr>";
    }
